 ...
 * Build: http://modernizr.com/download/#-printshiv
 */window.Modernizr = function(a, b, c) {
  ...
  var d = "2.6.2", e = {}, f = b.documentElement, g = "modernizr", h = b.createElement(g), i = h.style, j, k = {}.toString, l = {}, m = {}, n = {}, o = [], p = o.slice, q, r = {}.hasOwnProperty, s;
...
IBC.slideshow = function() {
  Slideshow = function($elm) {
    var orientation = $elm[0].className.match(/portrait|landscape/), keyword;
    this.$container = $elm;
  ...
  Slideshow.prototype = {
    createControls: function() {
      var $control, $controls = $('<ul class="controls clearfix" role="tablist" aria-label="Slideshow controls"/>'), rowLen = this.orientation === "portrait" ? 4 : 5, i, j;
      ...
      this.$controls.eq(0).addClass("active").attr("aria-selected", "true");
    },
    onClick: function(control) {
      ...
      if (idx !== -1) {
        ...
        this.$controls.removeClass("active").attr("aria-selected", "false");
        $(control).addClass("active").attr("aria-selected", "true");
      }
    },
    init: function() {
      var self = this;
...
IBC.video = function() {
  return {
    setUpCaptions: function() {
      var $transcripts = $(".video-transcript"), onClick;
      if ($transcripts.length) {
        ...
        $transcripts.each(function(idx) {
          var $transcript = $(this), $toggle = $transcript.siblings("p").find("a.transcript-toggle");
